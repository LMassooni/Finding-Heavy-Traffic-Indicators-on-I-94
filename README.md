...
This allows the system to execute the script **daily or at predefined intervals**, enabling the dataset to be continuously updated and analyzed.crontab -e# Análise de Fluxo de Tráfego: Rodovia I-94
